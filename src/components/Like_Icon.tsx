...
export const Like_Icon = () => {
    ...
    if(like){
      return(
        <svg className='cursor-pointer' onClick={() => setlike(!like)} width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      return(
        <svg className='cursor-pointer'  onClick={() => setlike(!like)} width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
