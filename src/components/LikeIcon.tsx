...
export const LikeIcon = () => {
  ...
  if (like) {
    return (
      <svg onClick={() => setlike(!like)} className="cursor-pointer absolute right-2 top-2" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
      <svg onClick={() => setlike(!like)} className="cursor-pointer absolute right-2 top-2" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
