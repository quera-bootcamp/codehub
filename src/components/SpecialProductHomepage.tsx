  ...
  return (
    <div className='w-full'>
        <div className='w-full m-6 flex flex-row justify-between items-center'>
            ...
            <Button children='فروشگاه' button_style='text-default-100 cursor-pointer px-8 py-2 rounded-xl' />
        </div>
        <HomepageCardContainer style_for_card='w-56' style='w-full' items={items} />
    </div>
  )
}
