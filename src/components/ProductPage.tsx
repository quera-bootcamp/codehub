          ...
          <form className="flex flex-col space-y text-right">
            <div className="pb-6">
              ...
              <select
                ...
                className="block bg-default-50 w-full border border-default-300 rounded-md shadow-sm focus:border-danger-500 focus:outline-none p-2 text-right"
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="block w-full border border-default-300 rounded-md shadow-sm  focus:border-danger-500 focus:outline-none p-2 h-32 text-right"
